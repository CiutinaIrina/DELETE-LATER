...
This is the "Rock Paper Scissors X99" CodeCademy project that i have worked on during the "Back-End Apps with JavaScript" course path.
The aim for this project is to code the game logic for a more complex game of rock-paper-scissors.
All of my work has been created with the aim of passing every single test in the testing suite.
I have also worked on the optional task of generating a set of moves for the computer.

### References

I have conducted all of my work inside the *game-logic.js* file.
All the other files have been downloaded from the Codecademy website and i **do not** take credit for creating them.

Here is the link to the project: https://www.codecademy.com/paths/create-a-back-end-app-with-javascript/tracks/bapi-javascript-conditionals-and-functions/modules/project-rock-paper-scissors-x-99/informationals/bapi-p1-rock-paper-scissors-x99.

Down from here is the original *README.md* for the project.
